...
const WorkingStep = () => {
  return (
    <div
      className="relative bg-cover bg-center py-12 w-full"
      ...
      >
        <div className="text-white text-center mb-20">
          ...
          <p className="text-lg md:w-1/2 w-full mx-auto">
            ...
            Praesentium, ut. Qui asperiores ipsum nam ut neque sunt tenetur
            deserunt obcaecati.
          </p>
        </div>
        ...
        <div className="flex flex-col md:w-4/5 mx-auto md:flex-row gap-8">
          <div className="relative bg-white text-center rounded-lg p-6 flex-1">
            ...
            <p className="my-2">
              ...
              consectetur adipisicing elit. Esse, commodi.
            </p>
          </div>
          <div className="relative bg-white text-center rounded-lg p-6 flex-1">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primary text-white size-14 rounded-full flex items-center justify-center text-xl font-bold">
